...
Built for **Paper, Spigot and forks like Purpur <!-- dl:sync:paper_display -->1.19 – 26.2<!-- /dl:sync -->** on **Java <!-- dl:sync:java -->8<!-- /dl:sync -->+**, tested with Geyser/Floodgate (Bedrock cross-play).
...
- **Server:** Bukkit-compatible — Paper, Spigot, or a fork such as Purpur. Built and tested against **<!-- dl:sync:paper_display -->1.19 – 26.2<!-- /dl:sync -->**; the plugin itself compiles against the Bukkit API at `<!-- dl:sync:min_paper -->1.13<!-- /dl:sync -->`, so it uses no Paper-only API.
